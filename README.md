...
[   3] [Active     ] [    1] java driver for bh1750fvi - ambient light sensor (0.1.1)
[   4] [Active     ] [    1] bluetooth scanner (0.1.4)
[   5] [Active     ] [    1] bluez-dbus-osgi (0.1.2.201911022022)
[   6] [Active     ] [    1] java driver for bme280 - combined humidity, pressure and temperature sensor (0.1.1)
...
- [bme280-driver 0.1.1](https://github.com/s5uishida/bme280-driver)
- [bh1750fvi-driver 0.1.1](https://github.com/s5uishida/bh1750fvi-driver)
