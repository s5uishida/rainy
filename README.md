...
[   3] [Active     ] [    1] bluetooth scanner (0.1.3)
[   4] [Active     ] [    1] bluez-dbus-osgi (0.1.2.SNAPSHOT)
[   5] [Active     ] [    1] bsd-parser-core (0.3.4)
[   6] [Active     ] [    1] bsd-parser-gson (0.3.4)
[   7] [Active     ] [    1] java driver for ti sensortag cc2650 (0.1.1)
[   8] [Active     ] [    1] cron4j-osgi (2.2.5)
[   9] [Active     ] [    1] Gson (2.8.5)
[  10] [Active     ] [    1] Guava: Google Core Libraries for Java (26.0.0.jre)
[  11] [Active     ] [    1] java driver for hc-sr501 - pir motion detector sensor module (0.1.1)
[  12] [Active     ] [    1] Java client for InfluxDB (2.15)
[  13] [Active     ] [    1] jSerialComm (2.5.1)
[  14] [Active     ] [    1] Jackson-annotations (2.9.9)
[  15] [Active     ] [    1] Jackson-core (2.9.9)
[  16] [Active     ] [    1] jackson-databind (2.9.9.1)
[  17] [Active     ] [    1] JavaBeans Activation Framework (1.2.0)
[  18] [Active     ] [    1] jaxb-api (2.4.0.b1808300359)
[  19] [Active     ] [    1] file:/home/pi/rainy-felix/bundle/jaxb-runtime-2.4.0-b180830.0438.jar
[  20] [Active     ] [    1] java driver for mh-z19b - intelligent infrared co2 module (0.1.2)
[  21] [Active     ] [    1] A modern JSON library for Kotlin and Java (1.7.0)
[  22] [Active     ] [    1] MessagePack serializer implementation for Java (0.8.17)
[  23] [Active     ] [    1] Netty/Buffer (4.1.38.Final)
[  24] [Active     ] [    1] netty-channel-fsm-osgi (0.3.0)
[  25] [Active     ] [    1] Netty/Codec (4.1.38.Final)
[  26] [Active     ] [    1] Netty/Codec/HTTP (4.1.38.Final)
[  27] [Active     ] [    1] Netty/Common (4.1.38.Final)
[  28] [Active     ] [    1] Netty/Handler (4.1.38.Final)
[  29] [Active     ] [    1] Netty/Resolver (4.1.38.Final)
[  30] [Active     ] [    1] Netty/Transport (4.1.38.Final)
[  31] [Active     ] [    1] Apache Felix Shell Service (1.4.3)
[  32] [Active     ] [    1] Apache Felix Shell TUI (1.4.1)
[  33] [Active     ] [    1] Apache ServiceMix :: Bundles :: jsr305 (3.0.2.1)
[  34] [Active     ] [    1] Apache ServiceMix :: Bundles :: okhttp (3.14.1.1)
[  35] [Active     ] [    1] Apache ServiceMix :: Bundles :: okio (1.15.0.1)
[  36] [Active     ] [    1] Apache ServiceMix :: Bundles :: retrofit (2.5.0.2)
[  37] [Active     ] [    1] Paho MQTT Client (1.2.1)
[  38] [Active     ] [    1] OSGi LogService implemented over SLF4J (1.7.26)
[  39] [Active     ] [    1] Pi4J :: Java Library (Core) (1.2)
[  40] [Active     ] [    1] java driver for ppd42ns - dust sensor module (0.1.7)
[  41] [Active     ] [    1] osgi activator of rainy - a tiny tool for iot data collection and monitoring (0.1.7)
[  42] [Active     ] [    1] OPC-UA bundle of rainy - a tiny tool for iot data collection and monitoring (0.1.5)
[  43] [Active     ] [    1] rainy - a tiny tool for iot data collection and monitoring (0.1.19)
[  44] [Active     ] [    1] java driver for rcwl-0516 - microwave presence sensor module (0.1.1)
[  45] [Active     ] [    1] sdk-client (0.3.4)
[  46] [Active     ] [    1] sdk-core (0.3.4)
[  47] [Active     ] [    1] slf4j-api (1.7.26)
[  48] [Resolved   ] [    1] slf4j-jdk14 (1.7.26)
[  49] [Active     ] [    1] stack-client (0.3.4)
[  50] [Active     ] [    1] stack-core (0.3.4)
...
- [bluetooth-scanner 0.1.3](https://github.com/s5uishida/bluetooth-scanner)
- [cc2650-driver 0.1.1](https://github.com/s5uishida/cc2650-driver)
...
- [rainy 0.1.19](https://github.com/s5uishida/rainy)
